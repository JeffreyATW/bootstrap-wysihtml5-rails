...
rangy.createModule("WrappedSelection", function(api, module) {
  ...
  var BOOLEAN = "boolean",
    ...
    getSelection, selectionIsCollapsed, CONTROL = "Control";
...
wysihtml5.dom.parse = (function() {
  ...
  function _handleAttributes(oldNode, newNode, rule) {
    var attributes = {},
      ...
      newUniqueClasses = [],
      oldClasses = [],
      classesLength, newClassesLength, currentClass, newClass, attributeName, newAttributeValue, method;
...
wysihtml5.dom.removeEmptyTextNodes = function(node) {
  var childNode, childNodes = wysihtml5.lang.array(node.childNodes).get(),
    childNodesLength = childNodes.length,
    i = 0;
  for (; i < childNodesLength; i++) {
    childNode = childNodes[i];
 ...
 */ (function(dom) {
  ...
  function resolveList(list, useLineBreaks) {
    ...
    var doc = list.ownerDocument,
      ...
      firstChild, lastChild, isLastChild, shouldAppendLineBreak, paragraph, listItem;
...
wysihtml5.quirks.cleanPastedHTML = (function() {
  ...
  function cleanPastedHTML(elementOrHtml, rules, context) {
    ...
    var element, isString = typeof(elementOrHtml) === "string",
      method, matches, matchesLength, i, j = 0;
    if (isString) {
      element = wysihtml5.dom.getAsDom(elementOrHtml, context);
    } else {
      element = elementOrHtml;
  ...
  /** @scope wysihtml5.Selection.prototype */
  {
    ...
    executeAndRestore: function(method, restoreScrollPosition) {
      var body = this.doc.body,
        ...
        range = this.getRange(this.doc),
        caretPlaceholder, newCaretPlaceholder, nextSibling, node, newRange;
    ...
    executeAndRestoreSimple: function(method) {
      var range = this.getRange(),
        body = this.doc.body,
        newRange, firstNode, lastNode, textNodes, rangeBackup;
    ...
    _selectLine_MSIE: function() {
      var range = this.doc.selection.createRange(),
        ...
        rangeBottom, rangeEnd, measureNode, i, j;
 ...
 */ (function(wysihtml5, rangy) {
  ...
  HTMLApplier.prototype = {
    ...
    isAppliedToRange: function(range) {
      var ancestors = [],
        ancestor, textNodes = range.getNodes([wysihtml5.TEXT_NODE]);
      if (!textNodes.length) {
...
(function(wysihtml5) {
  var undef, NODE_NAME = "A",
    dom = wysihtml5.dom;

  function _removeFormat(composer, anchors) {
    var length = anchors.length,
      i = 0,
      anchor, codeElement, textContent;
    for (; i < length; i++) {
      anchor = anchors[i];
  ...
  function _format(composer, attributes) {
    var doc = composer.doc,
      ...
      i = 0,
      length, anchors, anchor, hasElementChild, isEmpty, elementToSetCaretAfter, textContent, whiteSpace, j;
...
(function(wysihtml5) {
  var dom = wysihtml5.dom,
    ...
    ADDITIONAL_CSS_RULES = ["html                 { height: 100%; }", "body                 { height: 100%; padding: 1px 0 0 0; margin: -1px 0 0 0; }", "body > p:first-child { margin-top: 0; }", "._wysihtml5-temp     { display: none; }", wysihtml5.browser.isGecko ? "body.placeholder { color: graytext !important; }" : "body.placeholder { color: #a9a9a9 !important; }",
